...
@AppScoped
class TicketingSessionAdapter @Inject constructor(private val readerRepository: ReaderRepository) :
    TicketingSession {
  ...
  override fun getCardAid(): String? {
    return cardAid
  }
  ...
  override fun prepareAndSetCardDefaultSelection() {
    ...
    /* Select Calypso */
    val cardSelectionRequest_1TIC_ICA_1 = calypsoCardExtensionProvider.createCardSelection()
    cardSelectionRequest_1TIC_ICA_1
        .filterByDfName(AID_1TIC_ICA_1)
        .filterByCardProtocol(readerRepository.getCardReaderProtocol()!!.applicationProtocolName)

    /*
     * Add the selection case to the current selection
     */
    calypsoCardIndexAid_1TIC_ICA_1 =
        cardSelectionManager.prepareSelection(cardSelectionRequest_1TIC_ICA_1)

    val cardSelectionRequest_1TIC_ICA_3 = calypsoCardExtensionProvider.createCardSelection()
    ...
    calypsoCardIndexAid_1TIC_ICA_3 =
        cardSelectionManager.prepareSelection(cardSelectionRequest_1TIC_ICA_3)

    /*
     * NAVIGO
     */

    val cardSelectionRequest_AID_IDF = calypsoCardExtensionProvider.createCardSelection()
  ...
  override fun launchControlProcedure(locations: List<Location>): CardReaderResponse {
    return ControlProcedure()
        .launch(
            ...
            ticketingSession = this@TicketingSessionAdapter,
            locations = locations,
            now = DateTime.now())
  }
    ...
    cardResourceService
        ...
        .withPlugins(
            PluginsConfigurator.builder()
                .addPluginWithMonitoring(
                    readerRepository.getSamPlugin(),
                    readerRepository.getSamReaderConfiguratorSpi(),
        ...
        .withCardResourceProfiles(
            CardResourceProfileConfigurator.builder(samProfileName, samCardResourceExtension)
                .withReaderNameRegex(readerRepository.getSamReaderNameRegex())
                .build())
        .configure()
        ...
        cardResourceService.getCardResource(samProfileName)
            ?: throw IllegalStateException(
                java.lang.String.format(
                    ...
                    samProfileName,
                    readerRepository.getSamReaderNameRegex(),
                    readerRepository.getSamPlugin().name))
